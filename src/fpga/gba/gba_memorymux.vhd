...
begin
   ...
   -- can wait for queued flash program/sector/chip erase writes to drain.  In
   -- particular, FLASH_WRITEBLOCK remains non-IDLE across the whole block.
   memory_idle <= '1' when state = IDLE and mem_bus_ena = '0' else '0';
