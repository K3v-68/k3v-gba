...
for seed in $(seq "$START_SEED" "$END_SEED"); do
    ...
    docker run --rm --platform linux/amd64 \
      ...
      -w /build \
      raetro/quartus@sha256:817a783727492269d33aa98c903e8efc216e95d785ee76bfc8f426eddee98d0b \
...
if [[ "$BEST_SEED" -gt 0 && -f "$RESULTS_DIR/seed_$BEST_SEED/ap_core.rbf" ]]; then
    ...
    echo "To deploy: python3 scripts/reverse_bitstream.py $RESULTS_DIR/best/ap_core.rbf pkg/Cores/K3V.GBA/bitstream.rbf_r"
fi
